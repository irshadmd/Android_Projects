...
public class TSignInFragment extends Fragment {
    EditText et1, et2;
    Button loginbt;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tsign_in, container, false);
        et1 = view.findViewById(R.id.tf_email);
        et2 = view.findViewById(R.id.tf_password);
        loginbt = view.findViewById(R.id.lbtn);
