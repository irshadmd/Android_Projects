...
public class Teacher_home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.frag_home, new Fragment_Home());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            fragmentTransaction.replace(R.id.frag_home, new Fragment_Home());
            fragmentTransaction.commit();
        } else if (id == R.id.start_attendence) {
            Toast.makeText(getApplicationContext(), "CLicked!!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(getApplicationContext(), SubjectList.class);
            startActivity(intent);
        } else if (id == R.id.view_attendence) {
            Toast.makeText(this, "Clicked!!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(getApplicationContext(), ViewAttendenceold.class);
            startActivity(intent);
